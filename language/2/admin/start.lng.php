...
$lang['admin_task_remove_installdir1'] = 'Please completely remove the installation directory ({$path}) including all files and sub-folders. Leaving it on your server can compromise the security of your system.';

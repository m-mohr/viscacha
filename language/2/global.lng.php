...
$lang['ats_choose_desc'] = 'This forum allows you to mark topics as good or bad.  You should consider the following when rating threads:<br />'."\r\n".'<em>Good:</em>Threads rated "good" will be given priority by the system. Threads should be rated as good if they successfully resolve problems that are frequently encountered on the board. Any content that you feel is beneficial should be marked "good"<br />'."\r\n".'<em>Bad:</em>These topics will be given less priority by the system and can be automatically ignored by board members. Threads that are off topic, sensless or otherwise useless should get this mark.<br />'."\r\n".'<em>article:</em>Threads that are marked as "article" will be listed in the article overview and can be easily access this way.<br />'."\r\n".'<em>News:</em> News Threads are posted to the internal news system and will be offered to the readers via the board itself and alternativly on other websites via rss-feed.';
...
$lang['author'] = 'Author';
$lang['banned_head'] = 'Forum is locked.';
...
$lang['bbcodes_url_promtp2'] = 'Please provide text for the link';
...
$lang['log_wrong_data'] = 'You entered invalid login data or your account has not yet been activated.<br />Did you <a href="log.php?action=pwremind">forget your password</a>?';
...
$lang['no_board_given'] = 'No category/forum given';
...
$lang['register_veriword'] = 'Please enter the characters that you see.  This is to combat spam.';
...
$lang['section_closed'] = 'This section is locked.';
...
$lang['spellcheck_replace_all'] = 'Replace All';
...
$lang['timezone_desc'] = 'Current time: {$time}';
...
$lang['why_register_desc'] = 'In order to login you must be registered. Registering takes only a few seconds but gives you increased access.  The board administrator may also grant additional permissions to registered users. Before you login please ensure you are familiar with our terms of use and related policies. Please ensure you heed the forum rules as you use the forum.';

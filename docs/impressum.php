...
Email: <img alt="Email" src="images.php?action=textimage&amp;text=<?php echo base64_encode($config['forenmail']); ?>&enc=1" border="0" /><br />
...
treten, in dem der Autor von den Inhalten Kenntnis hat und es ihm technisch möglich
...
bzw. unter Angabe anonymisierter Daten oder eines Pseudonyms gestattet.</p>

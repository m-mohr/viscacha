...
<body>
<div class="border">
<h3><img src="<?php echo $tpl->img('rules'); ?>" alt="" /> Credits</h3>
  <div class="bbody">
	<p class="center">
	    <span class="stext"><a href="http://www.mamo-net.de" target="_blank">MaMo Net</a> proudly presents...</span><br />
	    <span class="btext">Viscacha <?php echo $config['version'];?></span>
	</p>
<p>
	<strong>Crew</strong>:<br />
	Software engineer: <a href="http://www.mamo-net.de" target="_blank">Matthias Mohr</a><br />
	<em>Thanks to all testers and users who reported bugs to me.</em><br />
	<strong>License:</strong><br />
	Viscacha is Free Software released under the GNU/GPL License.
	</p><p>
	...
	<li><a href="http://qbnz.com/highlighter" target="_blank">GeSHi 1.0.7.7 by Nigel McNie</a> (Syntax Highlighting; GPL)</li>

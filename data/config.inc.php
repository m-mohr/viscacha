...
$config['fname'] = 'Viscacha 0.9 Development';
$config['foffline'] = 0;
...
$config['sig_bblist'] = 1;
$config['sig_bbot'] = 0;
$config['smileypath'] = 'assets/smileys';
$config['smileyurl'] = 'assets/smileys';
$config['smtp'] = 0;
$config['smtp_auth'] = 0;
$config['smtp_host'] = '';

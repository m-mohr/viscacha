...
function PclZipUtilTranslateWinPath($p_path, $p_remove_disk_letter = true) {
	if (function_exists('php_uname') && stristr(php_uname(), 'windows') !== false || isset($_SERVER['OS']) && stristr($_SERVER['OS'], 'Windows') !== false || defined(PHP_OS) && strtoupper(substr(PHP_OS, 0, 3)) == 'WIN') {

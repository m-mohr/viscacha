...
class PHPMailer
{
    ...
    */
    ...
    function SmtpSend($header, $body) {
		...
		$cntbr = count($bad_rcpt);
        if($cntbr > 0) // Create error message
        {
            for($i = 0; $i < $cntbr; $i++)
            {
                if($i != 0) { $error .= ", "; }
    ...
    function CreateHeader() {
        ...
        // Add custom headers
        $cntch = count($this->CustomHeader);
        for($index = 0; $index < $cntch; $index++)
        {

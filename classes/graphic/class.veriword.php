...
class VeriWord {
	...
	function _draw_text() {
		...
		if ($this->settings['colortext']) {
			...
			$color_array[]  = array(mt_rand(0,50), mt_rand(200,255), mt_rand(0,50)); // Gr�n
			...
			$color_array[]  = array(mt_rand(0,50), mt_rand(170,230), mt_rand(170,230)); // T�rkis
			$color_array[]  = array(mt_rand(0,50), mt_rand(0,50), mt_rand(0,50)); // Grey
			$color_array[]  = array(mt_rand(150,200), mt_rand(40,150), mt_rand(0,40)); // Braun-�hnlich

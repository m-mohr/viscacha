...
class Snoopy
{
	...
	var $read_timeout	=	8;					// timeout on read operations, in seconds
												// supported only since PHP 4 Beta 4
												// set to 0 to disallow timeouts
	var $timed_out		=	false;				// if a read operation timed out
	var	$status			=	0;					// http request status

	var $temp_dir		=	"./temp";				// temporary directory that the webserver
	...
	var $_fp_timeout	=	8;					// timeout for socket connection

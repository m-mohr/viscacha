...
<div class="bbody">
	...
	<table class="tables">
	 ...
	 <tr> 
	  <td class="mbox" width="50%">Pfad zum Forum:</span><br><span class="stext">Pfad zum Ordner in dem die Dateien liegen (ohne / am Ende).</span></td>
	  <td class="mbox" width="50%"><input type="text" name="fpath" value="<?php echo $fpath; ?>" size="50"></td> 
	 </tr>
	 <tr> 
	  <td class="mbox" width="50%">Emailadresse des Forums:</span><br><span class="stext">Wird bei allen ausgehenden Emails verwendet.</span></td>
